...
<div id="sidebar">
    <div class="profile">
      ...
      <ul class="nav-list">
        ...
        <li class="nav-item">
          <Link className='side-text-link' to="/admindash/adminviewreceipts">
          View Student Projects Receipts
          </Link>
        </li>
        <li class="nav-item">
          <Link className='side-text-link' to="/admindash/adminviewstudents">
           View Students Payment Status
          </Link>
        </li>
        <li class="nav-item">
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const tables = ['staff_membership', 'student_membership', 'student_projects', 'external_membership', 'internal_internship', 'external_internship'];
