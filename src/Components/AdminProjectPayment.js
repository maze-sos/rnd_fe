            ...
            <div className="form-container">
                ...
                <form className='projectform'>
                    ...
                    <div className="form-group">
                        ...
                        <textarea id="description" name="description" placeholder="Enter Description" rows="10" cols="50" required value={description} onChange={(e) => setDescription(e.target.value)} />
                    </div>
                    <div className="form-group">
                        <label htmlFor="fee">Fee Amount:</label>
                        <input id="fee" name="fee" placeholder="Enter the Fee Amount" required value={fee} onChange={(e) => setFee(e.target.value)} />
                    </div>
                    <div className="form-group">
                        <label htmlFor="link">Project Fee Payment Link:</label>
                        <input id="link" name="link" placeholder="Enter link" required value={link} onChange={(e) => setLink(e.target.value)} />
                    </div>
                    <div className="form-group">
